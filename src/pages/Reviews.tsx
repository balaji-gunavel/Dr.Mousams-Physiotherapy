...
const reviews = [
  { name: "Ramesh K.", text: "My recovery improved significantly within a few sessions. The treatment approach is thorough and Dr. Mousam Shah, PT takes time to explain every exercise. Highly professional clinic.", rating: 5, date: "2 months ago" },
  { name: "Priya S.", text: "Every session felt truly personalized. Dr. Mousam Shah, PT understood my condition deeply and the exercises prescribed were very effective. My neck pain reduced drastically.", rating: 5, date: "3 months ago" },
  { name: "Anand M.", text: "After my ACL surgery, I was nervous about recovery. Dr. Mousam Shah, PT guided me step by step with patience and expertise. I'm back to playing sports now!", rating: 5, date: "1 month ago" },
  ...
  { name: "Suresh N.", text: "Dr. Mousam Shah, PT is extremely knowledgeable and patient. My chronic lower back pain has reduced considerably after just a few weeks of treatment.", rating: 5, date: "3 months ago" },
  ...
  { name: "Deepa G.", text: "My elderly mother was having difficulty walking due to knee pain. After a few sessions with Dr. Mousam Shah, PT, her mobility has improved greatly. Wonderful care.", rating: 5, date: "2 months ago" },
  { name: "Arun V.", text: "The clinic is well-maintained and hygienic. Dr. Mousam Shah, PT's approach is evidence-based and the results speak for themselves. Very trustworthy practitioner.", rating: 5, date: "4 months ago" },
  { name: "Lakshmi R.", text: "Had cervical spondylitis for over a year. Other treatments didn't help. Dr. Mousam Shah, PT's approach was different — focused on understanding the cause. Feeling so much better now.", rating: 5, date: "3 months ago" },
];
