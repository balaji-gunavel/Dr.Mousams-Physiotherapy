...
const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const text = `Hi Dr. Mousam Shah, PT, my name is ${formData.name}. ${formData.message}. Please contact me at ${formData.phone}.`;
            ...
            <div className="grid md:grid-cols-2 gap-10">
              <div>
                ...
                <div className="mt-8 rounded-xl overflow-hidden border border-border">
                  <iframe
                    title="Dr. Mousam Shah, PT's Physiotherapy Location"
